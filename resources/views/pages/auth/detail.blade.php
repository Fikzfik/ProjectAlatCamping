...
<body id="body" class="">
    ...
    <nav data-aos="fade-right" class="flex justify-between items-center sm:pt-[2.323vw] pt-[9.302vw] sm:px-[4.271vw] px-[8.372vw] sm:mb-0 mb-[6.302vw]">
    ...
    <div class="sm:px-[4.271vw] px-[8.372vw] pt-[2.604vw]">
        <div class="text-white sm:text-[0.938vw] text-[3.291vw] flex justify-between">
            <ul class="space-x-[0.417vw] flex">
                <a data-aos="fade-right" data-aos-duration="500" data-aos-delay="300" href="index.html"><li>Home</li></a>
                <a data-aos="fade-right" data-aos-duration="500" data-aos-delay="350" href=""><li>/</li></a>
                <a data-aos="fade-right" data-aos-duration="500" data-aos-delay="400" href="dashboard.html"><li>All Products</li></a>
                <a data-aos="fade-right" data-aos-duration="500" data-aos-delay="450" href=""><li>/</li></a>
                <a data-aos="fade-right" data-aos-duration="500" data-aos-delay="500" href=""><li>Soft Green Oversized Shirt</li></a>
            </ul>
        </div>
    </div>
    ...
    <section class="sm:px-[4.271vw] px-[8.372vw] text-white pt-[3.1vw] relative">
        <div class="w-full flex sm:flex-row flex-col">
            <div class="sm:w-[70vw] w-[83.256vw]">
                <div class="border border-white sm:px-[1.563vw] px-[13.488vw] sm:py-[1.563vw] py-0 sm:w-[64.74vw] sm:h-[31.979vw] w-[83.256vw] h-[89.535vw]">
                    <div class="flex justify-center items-center relative">
                        <div id="sliderContainer" class="flex sm:gap-[0.833vw] gap-0 w-full overflow-x-auto no-scrollbar snap-mandatory sm:static">
                            <!-- https://www.birden.com.br/prod/1555/camiseta-oversized-collective-grove#s8203 -->
                            <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" class="flex-shrink-0">
                                <img src="assets/images/detail-1.png" alt="" class="sm:w-[20vw] w-[55.814vw] sm:h-[28.542vw] h-[89.07vw] object-cover">
                            </div>
                            <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="350" class="flex-shrink-0">
                                <img src="assets/images/detail-2.png" alt="" class="sm:w-[20vw] w-[55.814vw] sm:h-[28.542vw] h-[89.07vw] object-cover">
                            </div>
                            <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="400" class="flex-shrink-0">
                                <img src="assets/images/detail-3.png" alt="" class="sm:w-[20vw] w-[55.814vw] sm:h-[28.542vw] h-[89.07vw] object-cover">
                            </div>
                            <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="450" class="flex-shrink-0">
                                <img src="assets/images/detail-1.png" alt="" class="sm:w-[20vw] w-[55.814vw] sm:h-[28.542vw] h-[89.07vw] object-cover">
                            </div>
                            <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" class="flex-shrink-0">
                                <img src="assets/images/detail-2.png" alt="" class="sm:w-[20vw] w-[55.814vw] sm:h-[28.542vw] h-[89.07vw] object-cover">
                            </div>
                            <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="550" class="flex-shrink-0">
                                <img src="assets/images/detail-3.png" alt="" class="sm:w-[20vw] w-[55.814vw] sm:h-[28.542vw] h-[89.07vw] object-cover">
                            </div>
                        </div>
                        <button data-aos="fade-right" data-aos-duration="500" data-aos-delay="600" id="prevBtn" class="absolute bg-white sm:w-[4.74vw] w-[16.279vw] sm:h-[5.885vw] h-[20.93vw] sm:mr-0 mr-[-13.488vw] right-0 flex justify-center items-center z-20">
                            <svg viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg" class="rotate-[-90deg] sm:w-[1.042vw] w-[5.581vw] sm:h-[1.927vw] h-[3.488vw]">
                                <path d="M11.91 -3.91006e-05L12.97 1.06096L7.193 6.83996C7.10043 6.93312 6.99036 7.00704 6.86911 7.05749C6.74786 7.10794 6.61783 7.13391 6.4865 7.13391C6.35517 7.13391 6.22514 7.10794 6.10389 7.05749C5.98264 7.00704 5.87257 6.93312 5.78 6.83996L0 1.06096L1.06 0.000960827L6.485 5.42496L11.91 -3.91006e-05Z" fill="#131314"/>
                                </svg>
                        </button>
                        <button data-aos="fade-left" data-aos-duration="500" data-aos-delay="600" id="nextBtn" class="absolute bg-white sm:w-[4.74vw] w-[16.279vw] sm:h-[5.885vw] h-[20.93vw] sm:ml-0 ml-[-13.488vw] left-0 flex justify-center items-center z-20">
                            <svg viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg" class="rotate-90 sm:w-[1.042vw] w-[5.581vw] sm:h-[1.927vw] h-[3.488vw]">
                                <path d="M11.91 -3.91006e-05L12.97 1.06096L7.193 6.83996C7.10043 6.93312 6.99036 7.00704 6.86911 7.05749C6.74786 7.10794 6.61783 7.13391 6.4865 7.13391C6.35517 7.13391 6.22514 7.10794 6.10389 7.05749C5.98264 7.00704 5.87257 6.93312 5.78 6.83996L0 1.06096L1.06 0.000960827L6.485 5.42496L11.91 -3.91006e-05Z" fill="#131314"/>
                                </svg>
                        </button>
                    </div>
                ...
                <section class="text-white pt-[5.814vw]">
                    <div class="">
                        <div class="flex sm:flex-row flex-col sm:gap-[4.115vw] gap-0">
                            ...
                            <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" class="sm:w-[30vw] w-[83.256vw] space-y-[3vw] sm:hidden inline overflow-y-auto h-auto scrollbar-hide top-[1.2vw]">
                                <div class="">
                                    <div class="grid gap-y-[4.651vw]">
                                        <div class="">
                                            ...
                                            <div class="flex gap-x-[1.395vw] pt-[2.791vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[4.651vw] h-[4.651vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[4.651vw] h-[4.651vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[4.651vw] h-[4.651vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[4.651vw] h-[4.651vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[4.651vw] h-[4.651vw]">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="flex space-x-4">
                                                <div class="flex space-x-[3.553vw]">
                                                    <div class="">
                                                        <input type="radio" id="option7" name="option" class="hidden peer">
                                                        <label for="option7" class="flex items-center justify-center w-[10.698vw] h-[10.698vw] text-white text-[3.256vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                                          S
                                                        </label>
                                                    </div>
                                                    <div class="">
                                                        <input type="radio" id="option8" name="option" class="hidden peer">
                                                        <label for="option8" class="flex items-center justify-center w-[10.698vw] h-[10.698vw] text-white text-[3.256vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                                          M
                                                        </label>
                                                    </div>
                                                    <div class="">
                                                        <input type="radio" id="option9" name="option" class="hidden peer">
                                                        <label for="option9" class="flex items-center justify-center w-[10.698vw] h-[10.698vw] text-white text-[3.256vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                                          L
                                                        </label>
                                                    </div>
                                                    <div class="">
                                                        <input type="radio" id="option10" name="option" class="hidden peer">
                                                        <label for="option10" class="flex items-center justify-center w-[10.698vw] h-[10.698vw] text-white text-[3.256vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                                          XL
                                                        </label>
                                                    </div>
                                                    <div class="">
                                                        <input type="radio" id="option11" name="option" class="hidden peer">
                                                        <label for="option11" class="flex items-center justify-center w-[10.698vw] h-[10.698vw] text-white text-[3.256vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                                          XXL
                                                        </label>
                                                    </div>
                                                    <div class="">
                                                        <input type="radio" id="option12" name="option" class="hidden peer">
                                                        <label for="option12" class="flex items-center justify-center w-[10.698vw] h-[10.698vw] text-white text-[3.256vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                                          XXXL
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="flex items-center justify-between w-[29.767vw] h-[11.628vw] border border-white text-[3.256vw]">
                                        ...
                                        <div class="text-dark space-y-[2.791vw] flex flex-col">
                                            <button class="bg-white w-full h-[16.047vw] text-[4.651vw] mt-[0.833vw]"><h2 class="font-medium"><a href="bag.html">Add to Bag</a></h2></button>
                                            <button class="border border-white text-white w-full h-[16.047vw] text-[4.651vw]">
                                                <div class="flex justify-center items-center gap-x-[0.8vw]">
                                                    <img src="assets/icons/love-icon.svg" alt="" class="w-[6.977vw] h-[6.977vw]">
                                    ...
                                    <div class="">
                                        <a href="javascript:void(0)" onclick="productDetails()" class="space-y-[1vw]">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <img id="arrowIcon9" src="assets/icons/arrow-icon.svg" alt="" class="w-[3.256vw] rotate-0 transition-transform duration-500">
                                            </div>
                                            <hr class="w-full">
                                        </a>
                                        <div class="overflow-hidden max-h-0 transition-all duration-500 ease-in-out space-y-[4.884vw] m-0" id="ProductDetail">
                                            <div>
                                                <p class="text-[2.791vw]">Oversized Streetwear T-Shirt - "Soft Green Oversized"</p>
                                            </div>
                                            
                                            <div>
                                                <ul id="productDetailsList" class="text-[2.791vw]">
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Color : Green</li>
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Size : Oversized</li>
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Material : 100% Cotton</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div  class="text-[2.791vw]">
                                                ...
                                                <ul id="featuresList" class="list-disc ps-[1vw]">
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Oversized Fit: The t-shirt has a relaxed, oversized fit for a comfortable and stylish look.</li>
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">High-Quality Material: Made from 100% soft cotton for maximum comfort and breathability.</li>
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Durable Construction: The t-shirt is built to last with double-stitched seams and a reinforced neckline.</li>
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Eye-Catching Design: Clean green graphic and text make this t-shirt a standout piece.</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="text-[2.791vw]">
                                                ...
                                                <ul  id="careInstructionsList"  class="list-disc ps-[1vw]">
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Machine wash cold with like colors</li>
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Tumble dry low</li>
                                                    <li class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Do not iron directly on the graphic</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>                                    
                                    ...
                                    <div class="">
                                        <a href="javascript:void(0)" onclick="moreInfo()" class="space-y-[1vw]">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <img id="arrowIcon10" src="assets/icons/arrow-icon.svg" alt="" class="w-[3.256vw] rotate-0"> 
                                            </div>
                                            <hr class="w-full">
                                        </a>
                                        <div class="space-y-[1vw] overflow-hidden max-h-0 transition-all duration-500 ease-in-out" id="moreInfo">
                                            <div>
                                                <p class="opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out text-[2.791vw]">Soft Green means something different to everyone. Let this oversized T-shirt be the canvas for your story. Pair it with your favorite accessories and create a unique and personal style.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col sm:w-[22.188vw] w-[83.256vw] sm:mt-0 mt-[9.302vw]">
                                <h2 data-aos="fade-right" data-aos-duration="500" data-aos-delay="200" class="sm:text-[1.146vw] text-[4.651vw] font-semibold pb-[1.979vw]">Rating & Review</h2>
                                <div class="space-y-[2vw]">
                                    <div class="flex sm:flex-row flex-col justify-between items-center">
                                        <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250" class="flex flex-col sm:items-start items-center">
                                            <h1 class="sm:text-[3.333vw] text-[13.953vw]">4,34</h1>
                                            <div class="flex sm:space-x-[0.313vw] space-x-[1.395vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.186vw] sm:h-[0.943vw] h-[4.186vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.186vw] sm:h-[0.943vw] h-[4.186vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.186vw] sm:h-[0.943vw] h-[4.186vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.186vw] sm:h-[0.943vw] h-[4.186vw]">
                                                <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.186vw] sm:h-[0.943vw] h-[4.186vw]">
                                            </div>
                                            <h2 class="sm:text-[0.938vw] text-[3.256vw] font-semibold sm:pt-[1vw] pt-[4.186vw] sm:pb-0 pb-[6.512vw]">23 Reviews</h2>
                                        </div>
                                        <div class="space-y-[0.5vw]">
                                            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="300" class="flex items-center sm:space-x-[0.677vw] space-x-[6.047vw]">
                                                <div class="flex sm:space-x-[0.677vw] space-x-[3.023vw] items-center">
                                                    <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.419vw] sm:h-[0.943vw] h-[4.419vw]">
                                                    <p class="sm:text-[1.042vw] text-[3.721vw] font-semibold">1</p>
                                                </div>
                                                <div class="">
                                                    <div class="sm:w-[10.833vw] w-[68.605vw] sm:h-[0.938vw] h-[4.186vw] border border-white" style="background: linear-gradient(to right, white 30%, transparent 30%);"></div>
                                                </div>                            
                                            </div>
                                            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="350" class="flex items-center sm:space-x-[0.677vw] space-x-[5.116vw]">
                                                <div class="flex sm:space-x-[0.677vw] space-x-[3.023vw] items-center">
                                                    <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.419vw] sm:h-[0.943vw] h-[4.419vw]">
                                                    <p class="sm:text-[1.042vw] text-[3.721vw] font-semibold">2</p>
                                                </div>
                                                <div class="">
                                                    <div class="sm:w-[10.833vw] w-[68.605vw] sm:h-[0.938vw] h-[4.186vw] border border-white" style="background: linear-gradient(to right, white 55%, transparent 30%);"></div>
                                                </div>                              
                                            </div>
                                            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="400" class="flex items-center sm:space-x-[0.677vw] space-x-[5.116vw]">
                                                <div class="flex sm:space-x-[0.677vw] space-x-[3.023vw] items-center">
                                                    <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.419vw] sm:h-[0.943vw] h-[4.419vw]">
                                                    <p class="sm:text-[1.042vw] text-[3.721vw] font-semibold">3</p>
                                                </div>
                                                <div class="">
                                                    <div class="sm:w-[10.833vw] w-[68.605vw] sm:h-[0.938vw] h-[4.186vw] border border-white" style="background: linear-gradient(to right, white 75%, transparent 30%);"></div>
                                                </div>                             
                                            </div>
                                            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="450" class="flex items-center sm:space-x-[0.677vw] space-x-[5.116vw]">
                                                <div class="flex sm:space-x-[0.677vw] space-x-[3.023vw] items-center">
                                                    <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.419vw] sm:h-[0.943vw] h-[4.419vw]">
                                                    <p class="sm:text-[1.042vw] text-[3.721vw] font-semibold">4</p>
                                                </div>
                                                <div class="">
                                                    <div class="sm:w-[10.833vw] w-[68.605vw] sm:h-[0.938vw] h-[4.186vw] border border-white" style="background: linear-gradient(to right, white 45%, transparent 30%);"></div>
                                                </div>                              
                                            </div>
                                            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="500" class="flex items-center sm:space-x-[0.677vw] space-x-[5.116vw]">
                                                <div class="flex sm:space-x-[0.677vw] space-x-[3.023vw] items-center">
                                                    <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[4.419vw] sm:h-[0.943vw] h-[4.419vw]">
                                                    <p class="sm:text-[1.042vw] text-[3.721vw] font-semibold">5</p>
                                                </div>
                                                <div class="">
                                                    <div class="sm:w-[10.833vw] w-[68.605vw] sm:h-[0.938vw] h-[4.186vw] border border-white" style="background: linear-gradient(to right, white 80%, transparent 30%);"></div>
                                                </div>                              
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="300">
                                        <h2 class="font-semibold sm:text-[1.146vw] text-[4.651vw] sm:mt-0 mt-[9.302vw]">Writing Review</h2>
                                        <div class="flex items-center sm:space-x-[0.313vw] space-x-[1.395vw] sm:pt-[0.99vw] pt-[4.419vw]">
                                            <img src="assets/icons/outline-stars-icon.svg" alt="" class="sm:w-[1.042vw] w-[4.651vw] sm:h-[0.938vw] h-[4.651vw]">
                                            <img src="assets/icons/outline-stars-icon.svg" alt="" class="sm:w-[1.042vw] w-[4.651vw] sm:h-[0.938vw] h-[4.651vw]">
                                            <img src="assets/icons/outline-stars-icon.svg" alt="" class="sm:w-[1.042vw] w-[4.651vw] sm:h-[0.938vw] h-[4.651vw]">
                                            <img src="assets/icons/outline-stars-icon.svg" alt="" class="sm:w-[1.042vw] w-[4.651vw] sm:h-[0.938vw] h-[4.651vw]">
                                            <img src="assets/icons/outline-stars-icon.svg" alt="" class="sm:w-[1.042vw] w-[4.651vw] sm:h-[0.938vw] h-[4.651vw]">
                                    ...
                                    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="300">
                                        <h2 class="font-semibold sm:text-[1.146vw] text-[4.651vw] sm:mt-0 mt-[9.302vw]">Review</h2>
                                        <div class="sm:pt-[0.99vw] pt-[4.651vw]">
                                            <textarea name="" class="bg-transparent border border-white placeholder:text-white placeholder:opacity-50 sm:text-[0.938vw] text-[2.791vw] sm:p-[1vw] p-[3.488vw] sm:w-[22.188vw] w-full sm:h-[7.552vw] h-[21.628vw]" placeholder="Write your review here..."></textarea>
                                        </div>
                                    </div>
                                    
                                    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="300" >
                                        <h2 class="font-semibold sm:text-[1.146vw] text-[4.651vw] sm:mt-0 mt-[9.302vw]">Photo or Video (Optional)</h2>
                                        <div class="flex flex-col items-center justify-center">
                                            <label for="file-upload" class="cursor-pointer flex flex-col items-center justify-center sm:w-[22.188vw] w-full sm:h-[15vw] h-[46.512vw] ">
                                            <div class="border sm:p-[0.833vw] p-[4.651vw]">
                                                <img src="assets/icons/upload-icon.svg" alt="" class="sm:w-[3.125vw] w-[13.953vw] sm:h-[3.125vw] h-[13.953vw]">
                                            </div>
                                            <span class="text-center sm:text-[0.938vw] text-[2.791vw] sm:pt-[1.5vw] pt-[3.256vw]">Upload your product photo</span>
                                    ...
                                    <div>
                                        <h2 data-aos="fade-right" data-aos-duration="500" data-aos-delay="300" class="font-semibold sm:text-[1.146vw] text-[4.651vw]">Your Public Name & Email</h2>
                                        <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="350" class="sm:pt-[0.99vw] pt-[6.977vw] sm:space-y-[1.5vw] space-y-[3.256vw]">
                                            <input type="text" class="sm:w-[22.188vw] w-full sm:h-[4.219vw] h-[12.558vw] bg-transparent border border-white sm:text-[0.938vw] text-[2.791vw] sm:p-[1vw] p-[5.814vw]" placeholder="Your name">
                                            <input type="email" class="sm:w-[22.188vw] w-full sm:h-[4.219vw] h-[12.558vw] bg-transparent border border-white sm:text-[0.938vw] text-[2.791vw] sm:p-[1vw] p-[5.814vw]" placeholder="Your Email">
                                        </div>
                                        <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="400" class="sm:space-y-[1.5vw] space-y-[3.256vw] sm:mt-[2.5vw] mt-[6.977vw]">
                                            <button class="sm:w-[22.188vw] w-full sm:h-[2.604vw] h-[12.558vw] text-dark bg-white sm:text-[1.042vw] text-[3.256vw] font-medium">Submit Review</button>
                                            <button class="sm:w-[22.188vw] w-full sm:h-[2.604vw] h-[12.558vw] text-white border border-white sm:text-[1.042vw] text-[3.256vw] font-medium">Cancel Review</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:w-[38.49vw] w-[83.256vw]">
                                <h2 data-aos="fade-right" data-aos-duration="500" data-aos-delay="300" class="sm:text-[1.146vw] text-[4.651vw] font-semibold pb-[1.979vw] sm:mt-0 mt-[9.302vw]">Customer Review</h2>
                                <div  class="sm:space-y-[2.76vw] space-y-[9.302vw]">
                                    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="350" class="sm:space-y-[1vw] space-y-[2.558vw]">
                                        <div  class="flex justify-between">
                                            <div class="flex space-x-[2vw]">
                                                <img src="assets/images/reviewer-1.png" alt="" class="sm:w-[4.167vw] w-[17.674vw] sm:h-[4.167vw] h-[17.674vw]">
                                                <div class="grid sm:gap-y-[0.4vw] gap-y-[1.395vw]">
                                                    <h2 class="sm:text-[1.25vw] text-[3.721vw] font-medium sm:leading-none leading-none">Rick Atsley</h2>
                                                    <div class="flex sm:space-x-[0.4vw] space-x-[0.8vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                    </div>
                                                    <h2 class="sm:text-[1vw] text-[3.256vw]">The size is a bit smaller than the previous one</h2>
                                                </div>
                                            </div>
                                            <p class="sm:static absolute sm:text-[0.938vw] text-[2.791vw] sm:pl-0 pl-[64.419vw]">23 / 09 / 2024</p>
                                        </div>
                                        <div>
                                            <p class="sm:text-[0.938vw] text-[2.791vw]">The fabric is soft, and the fit is perfect. Love the stylish design and the color looks exactly like the picture. Great quality overall</p>
                                        </div>
                                    </div>
                                    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="400" class="sm:space-y-[1vw] space-y-[2.558vw]">
                                        <div class="flex justify-between">
                                            <div class="flex space-x-[1.25vw]">
                                                <img src="assets/images/reviewer-2.png" alt="" class="sm:w-[4.167vw] w-[17.674vw] sm:h-[4.167vw] h-[17.674vw]">
                                                <div class="grid sm:gap-y-[0.4vw] gap-y-[1.395vw]">
                                                    <h2 class="sm:text-[1.25vw] text-[3.721vw] font-medium sm:leading-none leading-none">Gilbert Janong</h2>
                                                    <div class="flex sm:space-x-[0.4vw] space-x-[0.8vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/outline-stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/outline-stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/outline-stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                    </div>
                                                    <h2 class="sm:text-[1vw] text-[3.256vw]">The size is a bit smaller than the previous one</h2>
                                    ...
                                    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="450" class="sm:space-y-[1vw] space-y-[2.558vw]">
                                        <div class="flex justify-between">
                                            <div class="flex space-x-[1.25vw]">
                                                <img src="assets/images/reviewer-3.png" alt="" class="sm:w-[4.167vw] w-[17.674vw] sm:h-[4.167vw] h-[17.674vw]">
                                                <div class="grid sm:gap-y-[0.4vw] gap-y-[1.395vw]">
                                                    <h2 class="sm:text-[1.25vw] text-[3.721vw] font-medium sm:leading-none leading-none">Kevin Durant</h2>
                                                    <div class="flex sm:space-x-[0.4vw] space-x-[0.8vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                    ...
                                    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="500" class="sm:space-y-[1vw] space-y-[2.558vw]">
                                        <div class="flex justify-between">
                                            <div class="flex space-x-[1.25vw]">
                                                <img src="assets/images/reviewer-4.png" alt="" class="sm:w-[4.167vw] w-[17.674vw] sm:h-[4.167vw] h-[17.674vw]">
                                                <div class="grid sm:gap-y-[0.4vw] gap-y-[1.395vw]">
                                                    <h2 class="sm:text-[1.25vw] text-[3.721vw] font-medium sm:leading-none leading-none">Lebron James</h2>
                                                    <div class="flex sm:space-x-[0.4vw] space-x-[0.8vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                    ...
                                    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="550" class="sm:space-y-[1vw] space-y-[2.558vw]">
                                        <div class="flex justify-between">
                                            <div class="flex space-x-[1.25vw]">
                                                <img src="assets/images/reviewer-5.png" alt="" class="sm:w-[4.167vw] w-[17.674vw] sm:h-[4.167vw] h-[17.674vw]">
                                                <div class="grid sm:gap-y-[0.4vw] gap-y-[1.395vw]">
                                                    <h2 class="sm:text-[1.25vw] text-[3.721vw] font-medium sm:leading-none leading-none">Kai Cenat</h2>
                                                    <div class="flex sm:space-x-[0.4vw] space-x-[0.8vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
                                                        <img src="assets/icons/stars-icon.svg" alt="" class="sm:w-[0.987vw] w-[2.791vw] sm:h-[0.943vw] h-[2.791vw]">
            ...
            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="400" class="w-[30vw] space-y-[3vw] sticky sm:inline hidden overflow-x-hidden overflow-y-auto max-h-[100vh] scrollbar-hide top-[1.2vw]">
                    ...
                    <div class="w-full grid gap-y-[1vw]">
                        <div class="">
                            ...
                            <div class="flex gap-x-[0.4vw] pt-[0.4vw]">
                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[0.938vw] h-[0.938vw]">
                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[0.938vw] h-[0.938vw]">
                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[0.938vw] h-[0.938vw]">
                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[0.938vw] h-[0.938vw]">
                                <img src="assets/icons/stars-icon.svg" alt="" class="w-[0.938vw] h-[0.938vw]">
                        ...
                        <div class="">
                            <h2 class="text-[1.146vw] font-medium pb-[1vw]">Size</h2>
                            <div class="flex space-x-4">
                                <div class="flex space-x-[1.042vw]">
                                    <div class="">
                                        <input type="radio" id="option1" name="option" class="hidden peer">
                                        <label for="option1" class="flex items-center justify-center w-[2.76vw] h-[2.76vw] text-white text-[0.938vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                          S
                                        </label>
                                    </div>
                                    <div class="">
                                        <input type="radio" id="option2" name="option" class="hidden peer">
                                        <label for="option2" class="flex items-center justify-center w-[2.76vw] h-[2.76vw] text-white text-[0.938vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                          M
                                        </label>
                                    </div>
                                    <div class="">
                                        <input type="radio" id="option3" name="option" class="hidden peer">
                                        <label for="option3" class="flex items-center justify-center w-[2.76vw] h-[2.76vw] text-white text-[0.938vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                          L
                                        </label>
                                    </div>
                                    <div class="">
                                        <input type="radio" id="option4" name="option" class="hidden peer">
                                        <label for="option4" class="flex items-center justify-center w-[2.76vw] h-[2.76vw] text-white text-[0.938vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                          XL
                                        </label>
                                    </div>
                                    <div class="">
                                        <input type="radio" id="option5" name="option" class="hidden peer">
                                        <label for="option5" class="flex items-center justify-center w-[2.76vw] h-[2.76vw] text-white text-[0.938vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                          XXL
                                        </label>
                                    </div>
                                    <div class="">
                                        <input type="radio" id="option6" name="option" class="hidden peer">
                                        <label for="option6" class="flex items-center justify-center w-[2.76vw] h-[2.76vw] text-white text-[0.938vw] bg-transparent border border-gray-300 cursor-pointer peer-checked:bg-white peer-checked:text-black">
                                          XXXL
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="">
                            ...
                            <div class="flex items-center justify-between w-[8vw] py-[0.6vw] border border-white text-[0.938vw]">
                        ...
                        <div class="text-dark space-y-[1.5vw]">
                            <button class="bg-white w-[23.958vw] py-[1vw] text-[1.302vw] mt-[0.833vw]"><h2 class="font-medium"><a href="bag.html">Add to Bag</h2></a></button>
                            <button class="border border-white text-white w-[23.958vw] py-[1vw] text-[1.302vw]">
                                <div class="flex justify-center items-center gap-x-[0.8vw]">
                                    <img src="assets/icons/love-icon.svg" alt="" class="w-[1.563vw] h-[1.302vw]">
                                    <h2 class="font-medium">Favorite</h2>
                                </div>
                            </button>
                        </div>
                    ...
                    <div class="space-y-[1vw]">
                        <a href="javascript:void(0)" onclick="productDetails2()" class="space-y-[1vw]">
                            <div class="flex items-center justify-between">
                                ...
                                <img id="arrowIcon11" src="assets/icons/arrow-icon.svg" alt="" class="w-[0.833vw] rotate-0 transition-transform duration-500">
                            </div>
                            <hr class="w-full">
                        </a>
                        <div class="overflow-hidden max-h-0 transition-all duration-500 ease-in-out space-y-[1vw]" id="ProductDetail2">
                            <div>
                    ...
                    <div class="space-y-[1vw]">
                        <a href="javascript:void(0)" onclick="moreInfo2()" class="space-y-[1vw]">
                            <div class="flex items-center justify-between">
                                ...
                                <img id="arrowIcon12" src="assets/icons/arrow-icon.svg" alt="" class="w-[0.833vw] rotate-0 transition-transform duration-500">
                            </div>
                            <hr class="w-full">
                        </a>
                        <div class="overflow-hidden max-h-0 transition-all duration-500 ease-in-out space-y-[1vw]" id="moreInfo2">
                            <div>
                                <p class="text-[0.938vw] opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out">Soft Green means something different to everyone. Let this oversized T-shirt be the canvas for your story. Pair it with your favorite accessories and create a unique and personal style.</p>
                            </div>
                        </div>
                    </div>                    
                </div>
        ...
        <h1 class="absolute top-[-6vw] left-0 right-0 bottom-0 text-[13.021vw] md:text-[12.7vw] font-extrabold text-text_dark flex justify-center z-[-1] shadow__text">
            T SHIRT
        </h1>
    </section>
