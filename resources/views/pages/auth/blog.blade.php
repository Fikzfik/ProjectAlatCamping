...
<body id="body" class="text-white relative">
    ...
    <div class="sm:px-[4.271vw] px-[8.372vw] pt-[2.604vw]">
        <div class="text-white text-[0.938vw] flex sm:flex-row flex-col justify-between">
            <ul class="sm:text-[0.938vw] text-[3.291vw] space-x-[0.417vw] flex">
                ...
                <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="300"><a href="">Blog</a></li>
            </ul>
        </div>
    </div>
    ...
    <section class="sm:px-[4.271vw] px-[8.372vw] relative pb-[1vw] mt-[5.625vw]">
        ...
        <div class="grid sm:grid-cols-3 grid-cols-1 sm:gap-x-[1vw] gap-x-0 sm:gap-y-[4vw] gap-y-[9.302vw] sm:mt-[2.5vw] mt-[9.302vw]">
            <div class="flex items-center">
                <a class="w-full" href="detailBlog.html">
                    <div class="" data-aos="fade-up" data-aos-duration="500" data-aos-delay="350">
                        <div class="overflow-hidden">
                        <img src="assets/images/detailblog-1.png" alt="" class="w-full sm:h-[22.083vw] h-[98.605vw] object-cover object-center transform transition-transform duration-300 ease-in-out hover:scale-110">
                        </div>
                        <div class="w-full sm:space-y-[0.5vw] space-y-[2.581vw] sm:pt-[1vw] pt-[6.279vw]">
                            <h2 class="w-full font-semibold sm:text-[1.25vw] text-[18px] truncate">Treadwear at Jakarta Fashion Expo 2024</h2>
                            <p class="sm:text-[0.938vw] text-[3.721vw]">23 / 09 / 2024</p>
                            <p class="sm:text-[0.938vw] text-[2.791vw] sm:text-left text-justify pt-0">The treadwear event held at the Jakarta Expo invited various designers to evaluate treadwear designs. This event was held to enliven treadwear's birthday...</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="flex items-center">
                <a class="w-full" href="detailBlog.html">
                    <div class="" data-aos="fade-up" data-aos-duration="500" data-aos-delay="400">
                        <div class="overflow-hidden">
                        <img src="assets/images/detailblog-2.png" alt="" class="w-full sm:h-[22.083vw] h-[98.605vw] object-cover object-center transform transition-transform duration-300 ease-in-out hover:scale-110">
                        </div>
                        <div class="w-full sm:space-y-[0.5vw] space-y-[2.581vw] sm:pt-[1vw] pt-[6.279vw]">
                            <h2 class="w-full font-semibold sm:text-[1.25vw] text-[18px] truncate">Look at the Treadwear Hoodie Design</h2>
                            <p class="sm:text-[0.938vw] text-[3.721vw]">23 / 09 / 2024</p>
                            <p class="sm:text-[0.938vw] text-[2.791vw] sm:text-left text-justify pt-0">The treadwear event held at the Jakarta Expo invited various designers to evaluate treadwear designs. This event was held to enliven treadwear's birthday...</p>
                        </div>
                    </div>
            ...
            <div class="flex items-center">
                <a class="w-full" href="detailBlog.html">
                    <div class="" data-aos="fade-up" data-aos-duration="500" data-aos-delay="450">
                        <div class="overflow-hidden">
                        <img src="assets/images/detailblog-3.png" alt="" class="w-full sm:h-[22.083vw] h-[98.605vw] object-cover object-center transform transition-transform duration-300 ease-in-out hover:scale-110">
                        </div>
                        <div class="w-full sm:space-y-[0.5vw] space-y-[2.581vw] sm:pt-[1vw] pt-[6.279vw]">
                            <h2 class="w-full font-semibold sm:text-[1.25vw] text-[18px] truncate">New 3 Variant Longs Sleeve’s Hoodie</h2>
                            <p class="sm:text-[0.938vw] text-[3.721vw]">23 / 09 / 2024</p>
                            <p class="sm:text-[0.938vw] text-[2.791vw] sm:text-left text-justify pt-0">The treadwear event held at the Jakarta Expo invited various designers to evaluate treadwear designs. This event was held to enliven treadwear's birthday...</p>
                        </div>
                    </div>
            ...
            <div class="flex items-center">
                <a class="w-full" href="detailBlog.html">
                    <div class="" data-aos="fade-up" data-aos-duration="500" data-aos-delay="500">
                        <div class="overflow-hidden">
                        <img src="assets/images/detailblog-4.png" alt="" class="w-full sm:h-[22.083vw] h-[98.605vw] object-cover object-center transform transition-transform duration-300 ease-in-out hover:scale-110">
                        </div>
                        <div class="w-full sm:space-y-[0.5vw] space-y-[2.581vw] sm:pt-[1vw] pt-[6.279vw]">
                            <h2 class="w-full font-semibold sm:text-[1.25vw] text-[18px] truncate">4R Treadwear Campaign</h2>
                            <p class="sm:text-[0.938vw] text-[3.721vw]">23 / 09 / 2024</p>
                            <p class="sm:text-[0.938vw] text-[2.791vw] sm:text-left text-justify pt-0">The treadwear event held at the Jakarta Expo invited various designers to evaluate treadwear designs. This event was held to enliven treadwear's birthday...</p>
                        </div>
                    </div>
            ...
            <div class="flex items-center">
                <a class="w-full" href="detailBlog.html">
                    <div class="" data-aos="fade-up" data-aos-duration="500" data-aos-delay="550">
                        <div class="overflow-hidden">
                        <img src="assets/images/detailblog-5.png" alt="" class="w-full sm:h-[22.083vw] h-[98.605vw] object-cover object-center transform transition-transform duration-300 ease-in-out hover:scale-110">
                        </div>
                        <div class="w-full sm:space-y-[0.5vw] space-y-[2.581vw] sm:pt-[1vw] pt-[6.279vw]">
                            <h2 class="w-full font-semibold sm:text-[1.25vw] text-[18px] truncate">Opening of Official Stores in Indonesia</h2>
                            <p class="sm:text-[0.938vw] text-[3.721vw]">23 / 09 / 2024</p>
                            <p class="sm:text-[0.938vw] text-[2.791vw] sm:text-left text-justify pt-0">The treadwear event held at the Jakarta Expo invited various designers to evaluate treadwear designs. This event was held to enliven treadwear's birthday...</p>
                        </div>
                    </div>
            ...
            <div class="flex items-center">
                <a class="w-full" href="detailBlog.html">
                    <div class="" data-aos="fade-up" data-aos-duration="500" data-aos-delay="600">
                        <div class="overflow-hidden">
                        <img src="assets/images/detailblog-6.png" alt="" class="w-full sm:h-[22.083vw] h-[98.605vw] object-cover object-center transform transition-transform duration-300 ease-in-out hover:scale-110">
                        </div>
                        <div class="w-full sm:space-y-[0.5vw] space-y-[2.581vw] sm:pt-[1vw] pt-[6.279vw]">
                            <h2 class="w-full font-semibold sm:text-[1.25vw] text-[18px] truncate">Coming Soon New Hoodie Edition</h2>
                            <p class="sm:text-[0.938vw] text-[3.721vw]">23 / 09 / 2024</p>
                            <p class="sm:text-[0.938vw] text-[2.791vw] sm:text-left text-justify pt-0">The treadwear event held at the Jakarta Expo invited various designers to evaluate treadwear designs. This event was held to enliven treadwear's birthday...</p>
                        </div>
                    </div>
        ...
        <h1 class="absolute top-[-6vw] left-0 right-0 bottom-0 text-[16.279vw] sm:text-[12.7vw] font-extrabold text-text_dark flex justify-center z-[-1] shadow__text">
            BLOG
        </h1>
    </section>
