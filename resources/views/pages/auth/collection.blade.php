    ...
    <div class="sm:px-[4.271vw] px-[8.372vw] pt-[2.604vw]">
        <div class="text-white text-[0.938vw] flex sm:flex-row flex-col justify-between">
            <ul class="sm:text-[0.938vw] text-[3.291vw] space-x-[0.417vw] flex">
                ...
                <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="300"><a href="collection.html">Collection</a></li>
                <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="300">/</li>
                <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="300"><a href="">Dark Series</a></li>
            </ul>
                    ...
                    <div class="space-y-[0.729vw]">
                        ...
                        <div id="dropdownList1" class="overflow-hidden max-h-[20vw] transition-all duration-500 ease-in-out"> <!-- Default open state -->
                            <ul class="text-[0.938vw] space-y-[0.5vw] max-w-[15vw]">
                                <li class="font-medium opacity-100 translate-x-0 transition-all duration-500 ease-in-out"><a href="">Dark Series</a></li>
                                <li class="opacity-60 translate-x-0 hover:opacity-100 transition-all duration-500 ease-in-out"><a href="">Summer Edition</a></li>
                                <li class="opacity-60 translate-x-0 hover:opacity-100 transition-all duration-500 ease-in-out"><a href="">Clean Art</a></li>
                                <li class="opacity-60 translate-x-0 hover:opacity-100 transition-all duration-500 ease-in-out"><a href="">Treadwear x Aerostreet</a></li>
                            </ul>
                        </div>
                    </div>                                                            
                </div>
            ...
            <div class="grid sm:grid-cols-4 grid-cols-2 sm:place-items-start place-items-center sm:gap-y-[2.344vw] gap-y-[9.767vw] sm:gap-x-[1.146vw] gap-x-[3.256vw]">
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" class="flex justify-center items-center sm:col-span-1 col-span-2 md:col-span-1">
                    <div class="space-y-[0.885vw] relative overflow-hidden">
                        ...
                        <img src="assets/images/dark-1.png" alt="" class="sm:w-[15.555vw] w-[83.256vw] sm:h-[20.859vw] h-[111.628vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="350" class="flex justify-center items-center">
                    <div class="flex flex-col justify-between h-auto">
                        <div class="overflow-hidden">
                            <img src="assets/images/dark-2.png" alt="" class="sm:w-[15.555vw] w-[39.767vw] sm:h-[15.115vw] h-[39.302vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                            <!-- https://pin.it/5OBKtVWaz -->
                        </div>
                        <div class="">
                            <div class="mt-[10px]">
                                <h2 class="sm:text-[0.938vw] text-[2.791vw] font-semibold truncate sm:w-[15.555vw] w-[40vw]">Sweater Dark Series</h2>
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="400" class="flex justify-center items-center">
                    <div class="flex flex-col justify-between h-auto">
                        <div class="overflow-hidden">
                            <img src="assets/images/dark-3.png" alt="" class="sm:w-[15.555vw] w-[39.767vw] sm:h-[15.115vw] h-[39.302vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                            <!-- https://pin.it/24zGqV8V5 -->
                        </div>
                        <div class="">
                            <div class="mt-[10px]">
                                <h2 class="sm:text-[0.938vw] text-[2.791vw] font-semibold truncate sm:w-[15.555vw] w-[40vw]">Short Dark Series</h2>
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="450" class="flex justify-center items-center">
                    <div class="flex flex-col justify-between h-auto">
                        <div class="overflow-hidden">
                            <img src="assets/images/dark-4.png" alt="" class="sm:w-[15.555vw] w-[39.767vw] sm:h-[15.115vw] h-[39.302vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                             <!-- https://images.app.goo.gl/R1FwJFf9BY23ZF3s6 -->
                        </div>
                        <div class="">
                            <div class="mt-[10px]">
                                <h2 class="sm:text-[0.938vw] text-[2.791vw] font-semibold truncate sm:w-[15.555vw] w-[40vw]">Hat Dark Series</h2>
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" class="flex justify-center items-center">
                    <div class="flex flex-col justify-between h-auto">
                        <div class="overflow-hidden">
                            <img src="assets/images/dark-5.png" alt="" class="sm:w-[15.555vw] w-[39.767vw] sm:h-[15.115vw] h-[39.302vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                             <!-- https://pin.it/KPdwGa88L -->
                        </div>
                        <div class="">
                            <div class="mt-[10px]">
                                <h2 class="sm:text-[0.938vw] text-[2.791vw] font-semibold truncate sm:w-[15.555vw] w-[40vw]">Beanie Dark Series</h2>
                                <p class="sm:text-[0.938vw] text-[2.326vw] opacity-60">Cap</p>
                            </div>
                            <div class="flex items-center sm:space-x-[0.313vw] space-x-[2.326vw] mt-[1vw]">
                                <h2 class="sm:text-[1.25vw] text-[3.256vw]">Rp. 175.000</h2>
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="550" class="sm:flex justify-center items-center hidden">
                    <div class="flex flex-col justify-between h-auto">
                        <div class="overflow-hidden">
                            <img src="assets/images/dark-6.png" alt="" class="sm:w-[15.555vw] w-[39.767vw] sm:h-[15.115vw] h-[39.302vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                            <!-- https://pin.it/6bYpGRWCS -->
                        </div>
                        <div class="">
                            <div class="mt-[10px]">
                                <h2 class="sm:text-[0.938vw] text-[2.791vw] font-semibold truncate sm:w-[15.555vw] w-[40vw]">Bucket Hat Dark Series</h2>
                                <p class="sm:text-[0.938vw] text-[2.326vw] opacity-60">Cap</p>
                            </div>
                            <div class="flex items-center sm:space-x-[0.313vw] space-x-[2.326vw] mt-[1vw]">
                                <h2 class="sm:text-[1.25vw] text-[3.256vw]">Rp. 175.000</h2>
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="600" class="col-span-2 flex justify-center items-center">
                    <div class="relative">
                        ...
                        <div class="absolute sm:w-[32.292vw] w-[83.256vw] sm:h-[10.426vw] h-[29.535vw] bg-gradient-to-t from-dark/90 to-dark/0 bottom-0 sm:px-[1.875vw] px-[4.884vw] sm:pt-[2.708vw] pt-[6.512vw]">
                            ...
                            <button class="sm:w-[11.042vw] w-[30.828vw] sm:h-[2.604vw] h-[7.072vw] text-dark bg-white sm:text-[1.042vw] text-[2.791vw] font-medium">Shop Now <span class="arrow">--></span></button>
                        </div>
                    </div>
                </div>
                <!-- End Item 7 -->
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" class="flex justify-center items-center">
                    <div class="flex flex-col justify-between h-auto">
                        <div class="overflow-hidden">
                            <img src="assets/images/dark-7.png" alt="" class="sm:w-[15.555vw] w-[39.767vw] sm:h-[15.115vw] h-[39.302vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                            <!-- https://pin.it/2SKLtUYOg -->
                        </div>
                        <div class="">
                            <div class="mt-[10px]">
                                <h2 class="sm:text-[0.938vw] text-[2.791vw] font-semibold truncate sm:w-[15.555vw] w-[40vw]">Shirt Dark Series</h2>
                                <p class="sm:text-[0.938vw] text-[2.326vw] opacity-60">T - Shirt</p>
                            </div>
                            <div class="flex items-center sm:space-x-[0.313vw] space-x-[2.326vw] mt-[1vw]">
                                <h2 class="sm:text-[1.25vw] text-[3.256vw]">Rp. 175.000</h2>
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="350" class="flex justify-center items-center">
                    <div class="flex flex-col justify-between h-auto">
                        <div class="overflow-hidden">
                            <img src="assets/images/dark-8.png" alt="" class="sm:w-[15.555vw] w-[39.767vw] sm:h-[15.115vw] h-[39.302vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                            <!-- https://pin.it/6XWuC9AJ3 -->
                        </div>
                        <div class="">
                            <div class="mt-[10px]">
                                <h2 class="sm:text-[0.938vw] text-[2.791vw] font-semibold truncate sm:w-[15.555vw] w-[40vw]">Long Pants Dark Series</h2>
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="400" class="sm:flex justify-center items-center hidden">
                    <a href="detail.html">
                        <div class="space-y-[0.885vw] relative  overflow-hidden">
                            <img src="assets/images/dark-9.png" alt="" class="w-[15.365vw] h-[20.859vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="450" class="flex justify-center items-center">
                    <div class="flex flex-col justify-between h-auto">
                        <div class="overflow-hidden">
                            <img src="assets/images/dark-10.png" alt="" class="sm:w-[15.555vw] w-[39.767vw] sm:h-[15.115vw] h-[39.302vw] object-cover object-top transform transition-transform duration-300 ease-in-out hover:scale-110">
                        </div>
                        <div class="">
                            <div class="mt-[10px]">
                                <h2 class="sm:text-[0.938vw] text-[2.791vw] font-semibold truncate sm:w-[15.555vw] w-[40vw]">Hoodie Dark Series</h2>
                ...
                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" class="sm:hidden flex justify-center items-center sm:col-span-1 col-span-2 md:col-span-1">
                    <a href="detail.html">
                        <div class="space-y-[0.885vw] relative">
                            <img src="assets/images/dark-9.png" alt="" class="sm:w-[15.555vw] w-[83.256vw] sm:h-[20.859vw] h-[111.628vw] object-cover object-top">
                            ...
                            <div class="absolute sm:w-[15.555vw] w-[83.256vw] sm:h-[10.426vw] h-[54.419vw] bg-gradient-to-t from-dark/90 to-dark/0 bottom-0">
                                ...
                                <div class="absolute bottom-0 sm:px-[0.938vw] px-[7.442vw] sm:pb-[1vw] pb-[7.442vw] text-white">
                                    <div>
                                        <h2 class="sm:text-[0.938vw] text-[4.651vw] leading-none">Graphic Dark Series</h2>
                                        <p class="sm:text-[0.938vw] text-[4.651vw] opacity-60">T - Shirt</p>
                                    </div>
