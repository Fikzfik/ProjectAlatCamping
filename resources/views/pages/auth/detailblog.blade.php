...
<body id="body" class="text-white relative">
    <div id="nav"
        class="w-[100vw] h-[216.744vw] overflow-x-hidden z-30 fixed pointer-events-none sm:hidden inline">
        <div id="sidebar"
            class="absolute right-0 bg-white w-[100vw] h-[216.744vw] px-[8.372vw] slide-out-left-active">
    ...
    <nav
        ...
        <div class="sm:inline hidden">
            <ul class="text-[0.938vw] text-white flex space-x-[1.615vw]">
                <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="200"><a
    ...
    <div class="sm:px-[4.271vw] px-[8.372vw] pt-[2.604vw]">
        <div class="text-white text-[0.938vw] flex sm:flex-row flex-col justify-between">
            <ul class="sm:text-[0.938vw] w-full text-[12px] space-x-[0.417vw] flex">
                <li><a data-aos="fade-right" data-aos-duration="500" data-aos-delay="200" href="index.html">Home</a>
                </li>
                <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="200">/</li>
                <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="300"><a href="blog.html">Blog</a>
                </li>
                <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="200">/</li>
                <li data-aos="fade-right" data-aos-duration="500" data-aos-delay="300"><a href="">Treadwear
                        at Jakarta Fashion Expo 2024</a></li>
            </ul>
        </div>
    </div>
    ...
    <section class="sm:px-[12.813vw] px-[8.372vw] sm:mt-[5vw] mt-[19.767vw] relative">
        <div>
            <img src="assets/images/detailblog-1.png" alt=""
                class="w-full sm:h-[35.885vw] h-[98.605vw] object-cover object-center">
            <div class="sm:mt-[3.073vw] mt-[7.442vw] sm:space-y-[3vw] space-y-[7.442vw]">
                ...
                <div class="sm:space-y-[1vw] space-y-[7.442vw]">
                    <h2 class="font-medium sm:text-[1.25vw] text-[4.651vw]">Exciting Treadwear Design Exhibition at
                        Jakarta Expo
                    </h2>
                    <p class="sm:text-[0.938vw] text-[2.791vw] sm:leading-normal leading-[5.814vw]">The treadwear
                        design exhibition held at the Jakarta Expo succeeded in attracting the attention of various
                        well-known designers. They gather in one place to showcase innovative works and evaluate the
                        latest trends in the world of treadwear design. This event is not only a competition event, but
                        also a celebration of designers' unlimited creativity.
                    </p>
                </div>
                ...
                <div class="sm:space-y-[1vw] space-y-[7.442vw]">
                    ...
                    <p class="sm:text-[0.938vw] text-[2.791vw] sm:leading-normal leading-[5.814vw]">Apart from being a
                        design competition, this event was also held to celebrate treadwear's birthday. Various
                        interesting activities such as fashion shows, workshops and work exhibitions are prepared to
                        enliven the celebration. Visitors are invited to learn more about the history and development of
                        treadwear over time. One of the main attractions of this event is the fashion show which
                        displays the works of selected designers. Models confidently strutted down the catwalk, showing
                        off unique and stylish treadwear designs. Starting from classic designs to futuristic ones,
                        everything is presented in a stunning fashion show. Apart from the fashion show, this event also
                        provides workshops guided by experts in the field of treadwear design. Workshop participants
                        have the opportunity to learn the latest techniques and exchange ideas with fellow designers.
                        Meanwhile, the work exhibition provides an opportunity for visitors to take a closer look at the
                        designer's works and gain inspiration.</p>
                </div>

                <div class="sm:space-y-[1vw] space-y-[7.442vw]">
                    <h2 class="font-medium sm:text-[1.25vw] text-[4.651vw]">Successful Treadwear Design Exhibition
                        Event</h2>
                    <p class="sm:text-[0.938vw] text-[2.791vw] sm:leading-normal leading-[5.814vw]">Overall, the
                        treadwear design exhibition at the Jakarta Expo could be said to be a great success. This event
                        not only succeeded in bringing together talented designers, but also provided inspiration for
                        the wider community. Hopefully events like this can continue to be held in the future to
                        encourage the development of the treadwear design industry in Indonesia.</p>
                </div>

                <div class="text-center">
                    <p><a href="blog.html" class="sm:text-[1.042vw] lg:text-[1.25vw]"><span class="arrow"><--
                                    </span><span class="underline">Back to Blogs</span></a></p>
                </div>
            </div>
        </div>
        <h1
            class="absolute sm:top-[-10vw] top-[-18vw] left-0 right-0 bottom-0 text-[13.021vw] md:text-[12.7vw] font-extrabold text-text_dark flex justify-center z-[-1] shadow__text">
            BLOG
        </h1>
    </section>
